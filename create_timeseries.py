...
def main(time_scale='h'):
    ...
    df[KALSHI_FEATURE_COLS+['price_close_next','price_high_next','price_low_next']] = df[KALSHI_FEATURE_COLS+['price_close_next','price_high_next','price_low_next']].astype(float)
    df.sort_index(inplace=True)
